...
class KaHFMEmbeddings(RecMixin, BaseRecommenderModel):
    ...
    def __init__(self, data, config, params, *args, **kwargs):
        ...
        self._params_list = [
            ...
            ("_dataset_n", "dataset_n", "dataset_n", None, None, None),
        ...
        features_file = '/home/alberto/PycharmProjects/GallucciKnowledge/kahfm_features_number.tsv'
        features = len(self._data.features)

        with open(features_file, 'a+') as file:
            row = f"{self._dataset_n}\t{features}\n"
            file.write(row)
    ...
    def name(self):
        return "KaHFMEmbeddings" \
               + "_e_" + str(self._epochs) \
               + "_bs_" + str(self._batch_size) \
